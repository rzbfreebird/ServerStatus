...
* 2018.08.21, 修改新样式，效果见 www.vpsmanager.tk  
...
执行下面的代码下载并运行脚本。
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/rzbfreebird/Script/master/status.sh && chmod +x status.sh
```
